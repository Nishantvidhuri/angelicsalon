...
function SecondSection() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-600 text-white pt-0 sm:pt-72">
      <div className="flex flex-wrap max-w-7xl mx-auto">
        {/* Left Column */}
        <div className="w-full lg:w-1/2 p-4 sm:p-6 lg:p-8 flex flex-col justify-center">
          <header>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-white mb-4 sm:mb-6">
              Natural cuts &amp; styling
            </h1>
          </header>
          <p className="text-white leading-relaxed text-sm sm:text-lg lg:text-xl mb-6 font-serif">
        ...
        <div className="w-full lg:w-1/2 p-4 sm:p-6 lg:p-8 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-lg sm:text-xl font-bold text-white font-[Playfair Display]">
                100% natural products
              </h4>
              <p className="text-white text-sm sm:text-base leading-relaxed font-[Poppins]">
